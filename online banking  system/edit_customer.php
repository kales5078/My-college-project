...
<body>
    <form class="add_customer_form" action="edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                <label>First Name :<label id="info_label"></label><br>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    ...
                    <option value="Aurangabad" <?php if ($branch == 'Aurangabad') {?> selected="selected" <?php }?>>Aurangabad</option>
                    <option value="Latur" <?php if ($branch == 'Latur') {?> selected="selected" <?php }?>>Latur</option>
                    <option value="Nagpur" <?php if ($branch == 'Nagpur') {?> selected="selected" <?php }?>>Nagpur</option>
                    <option value="Nanded" <?php if ($branch == 'Nanded') {?> selected="selected" <?php }?>>Nanded</option>
                </select>
            </div>
        </div>
Aurangabad
